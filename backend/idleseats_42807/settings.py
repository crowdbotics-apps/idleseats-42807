"""
Django settings for idleseats_42807 project.
...
ROOT_URLCONF = 'idleseats_42807.urls'
...
WSGI_APPLICATION = 'idleseats_42807.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "idleseats_42807 API",
    "DESCRIPTION": "API documentation for idleseats_42807 App",
    "VERSION": "v1",
}
